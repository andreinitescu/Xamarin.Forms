...
using WButtonBase = Windows.UI.Xaml.Controls.Primitives.ButtonBase;
using WImage = Windows.UI.Xaml.Controls.Image;
using Windows.UI.Xaml.Input;

namespace Xamarin.Forms.Platform.UWP
{
	public class ButtonBaseRenderer<TButton, TFormsButton> : ViewRenderer<TButton, TFormsButton>
		where TButton : Button, IElementConfiguration<TButton>
		where TFormsButton : WButtonBase, IFormsButtonBase, new()
	{
		bool _fontApplied;
		...
		protected override void OnElementChanged(ElementChangedEventArgs<TButton> e)
		{
			...
			if (e.NewElement != null)
			{
				if (Control == null)
				{
					TFormsButton button = CreateNativeControl();
		...
		protected virtual TFormsButton CreateNativeControl()
		{
			return new TFormsButton();
		}
