...
{
	//public class ButtonBaseRenderer<TButton> : ViewRenderer<TButton, UIButton>, where TButton : VisualElement, IFontElement, ITextElement, IButtonController, IElementConfiguration<TButton>, IPaddingElement
	//{
	//	bool _isDisposed;
	...
	//	public ButtonBaseRenderer() : base()
	//	{
	...
	//public class ButtonBaseRenderer<TButton> : ViewRenderer<TButton, UIButton>
